...
public class Schedule {
        ...
        private Person[] randomPlayers(Set<Person> players) throws NotEnoughParticipantsException {
            if (players.size() < 2){
        ...
        public SportsGame scheduleGame (Weekday day) throws NotEnoughParticipantsException {
            ...
            switch (day) {
                case MONDAY:
                    ...
                    players = randomPlayers(personList.getSetOfTennisPlayers());
                    game = new Tennis(players[0], players[1]);
                    break;
                case TUESDAY:
                    System.out.println("Football game is scheduled");
                    teams = randomTeams(teamList.getListFootballTeams());
